...
Требования:
- установленный [Ruby 4.0.3](https://www.ruby-lang.org/en/news/2026/04/21/ruby-4-0-3-released/) и новее
...
| `bin/future-payments` | Будущие выплаты — дивиденды и купоны на ближайшие 90 дней + промежуточный итог за месяц |
...
### Future payments: промежуточные итоги за месяц

В таблице будущих выплат после последней выплаты месяца выводится промежуточный итог за месяц.
Сумма итога подсвечивается ярко-зелёным цветом, а после итоговой строки добавляется пустая строка для визуального разделения секций.
